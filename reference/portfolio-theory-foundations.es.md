...
title: "Fundamentos de Teoría de Cartera para Inversiones Alternativas"
...
- El Teorema de Separación de Fondos Mutuos sostiene que la decisión de selección de activos de un inversor y su decisión de tolerancia al riesgo pueden separarse: una cartera construida a partir de un pequeño número de fondos diversificados logra mejores resultados ajustados por riesgo que una construida seleccionando valores individualmente.
- La frontera eficiente describe el conjunto de carteras que ofrecen el mayor rendimiento esperado para un nivel de riesgo dado; su existencia depende de que las clases de activos incluidas tengan baja correlación entre sí.
