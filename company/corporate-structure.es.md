...
Woodfine Capital Projects Inc. está constituida conforme a la Ley Canadiense de Sociedades por Acciones (CBCA), y está registrada extra-provincialmente para operar en Columbia Británica. Es la propietaria al 100% de sus subsidiarias y proporciona el marco de gobernanza en el que cada una opera. La entidad matriz no gestiona activos inmobiliarios ni desarrolla productos tecnológicos por sí misma.
...
MCorp (Woodfine Management Corp.) es una subsidiaria de propiedad absoluta de Woodfine Capital Projects Inc. Su mandato es la prestación de servicios dentro del grupo: MCorp contrata consultores externos y realiza las tareas que otras subsidiarias de WCP le delegan. **MCorp no es el socio general de ningún vehículo de Tenencia Directa, no es el administrador de ningún fideicomiso, y no origina ni rige las sociedades limitadas** a través de las cuales se mantienen los activos comerciales. No posee participación de promotor en esos vehículos: la compensación accionaria del promotor se mantiene a través de Benetti Holdings Inc., una subsidiaria separada de WCP, en garantía hasta que los socios limitados recuperen el 100% del capital aportado o se produzca un evento de liquidez definido (véase [[professional-centres-canada-lp-structure|la estructura de Professional Centres Canada LP]]).
...
- [[topic-vendor-customer-model|Modelo Proveedor-Cliente]] — la relación de servicios entre PointSav y el grupo
- [[topic-direct-hold-framework|Marco de Tenencia Directa]] — la estructura de propiedad de activos que opera cada órgano de gobierno
- [[professional-centres-canada-lp-structure|Estructura de Professional Centres Canada LP]] — el socio general, el asesor y la estructura accionaria del promotor del vehículo de Canadá, en detalle
- [[about-regulatory-posture|Postura Regulatoria]] — las obligaciones de divulgación ante la OSC aplicables al grupo
