...
Las estructuras de fondos tradicionales imponen puertas de redención, reservas de liquidez y períodos de bloqueo sujetos a la discrecionalidad del gestor del fondo. El Modelo de Transferencia de Capital no contiene ninguno de estos mecanismos — véase [[redemption-elimination|Eliminación de Redención]] para el fundamento estructural. Los términos de liquidez los determina el mercado de compradores dispuestos, no la política de la entidad corporativa. El [[perpetual-equity-model|modelo de capital perpetuo]] aplica la misma lógica a lo largo de un horizonte de tenencia indefinido.
...
- [[direct-hold-framework]] — la estructura de propiedad que hace libremente transferible el capital
- [[redemption-elimination]] — por qué no existe una facilidad de recompra corporativa
