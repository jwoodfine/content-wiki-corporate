...
Cuando el socio gestor declara una distribución, el monto agregado a distribuir se divide entre
el número total de participaciones en circulación para producir un monto de distribución por
participación. Cada tenedor de participaciones recibe el monto por participación multiplicado
por su número de participaciones.

No existe una clase preferente de participaciones, ni un rendimiento preferente mínimo que
deba satisfacerse antes de que las participaciones ordinarias participen, ni una distribución
...
- [[limited-partnership-structure]] — la forma de SC a través de la cual fluyen las
