...
title: "Estructura de gestión tripartita"
slug: tripartite-management-structure
aliases:
...
- La estructura separa tres funciones que un promotor inmobiliario convencional suele reunir bajo una única línea ejecutiva: construir el activo, administrar las obligaciones de divulgación continua de una Entidad de Reporte Regulada, y obtener capital.
- La primera pata la ejecuta Woodfine Advisors Inc. bajo un acuerdo de servicios de asesoría, bajo la autoridad del órgano de gobierno de cada vehículo — en Canadá, el socio general, Woodfine Professional Centres Inc. La segunda pata se administra bajo esa misma autoridad. Woodfine Management Corp. (MCorp) puede prestar apoyo administrativo delegado y consultores externos a cualquiera de las dos patas, pero no ostenta autoridad de gobierno sobre ninguna. La tercera pata se sitúa enteramente fuera del grupo Woodfine — un sindicato independiente de Gestores de Activos a través del cual el Capital Privado Calificado llega a la plataforma.
- Se trata de una separación funcional dentro de la gestión de una única Solución de Tenencia Directa. Es distinta de — y opera junto con — la separación corporativa descrita en [[corporate-structure|Estructura Corporativa]], que divide la propiedad, la tecnología, los servicios delegados y la gobernanza de los vehículos en el nivel del grupo.

## Ejecución del desarrollo y la construcción

La primera pata realiza el trabajo físico de la plataforma de Soluciones de Tenencia Directa: la disciplina de adquisición de sitios, la construcción de los Edificios Woodfine, y la entrega de cada proyecto conforme a las especificaciones de producto estandarizadas que el Programa de Expansión aplica en todas las jurisdicciones. En Canadá, este trabajo lo realiza Woodfine Advisors Inc. bajo su acuerdo de servicios de asesoría con el socio general, y se evalúa por su entrega — costo, cronograma y calidad de la edificación. No ostenta ninguna autoridad sobre cómo un vehículo divulga su condición financiera ni sobre cómo obtiene capital de terceros; esos juicios corresponden a las otras dos patas.
...
Combinar cualesquiera dos de estas patas bajo una autoridad común crearía un conflicto de interés directo. Una función que a la vez ejecuta la construcción y administra la divulgación podría verse incentivada a matizar el reporte de cumplimiento para proteger un cronograma o un presupuesto de construcción. Una función que a la vez obtiene capital y administra la divulgación podría verse incentivada a sincronizar o caracterizar la divulgación pública para favorecer una ronda de capital en curso. Mantener las patas separadas significa que el desempeño de la construcción, el reporte regulatorio y el acceso al capital quedan cada uno sujetos a un juicio independiente, y que una falla o una presión en una pata no compromete automáticamente a las otras dos. Esta separación también sustenta la lógica repetible del Programa de Expansión: a medida que la plataforma ejecuta sucesivas Soluciones de Tenencia Directa en distintas jurisdicciones, cada nuevo vehículo puede apoyarse en la misma estructura de tres patas sin concentrar autoridad adicional en ninguna función.
