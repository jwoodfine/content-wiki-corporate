...
An investor cannot exercise governance rights over an asset whose legal ledger they cannot access. The mandate closes this structural gap: a corporate entity that controls its own ledger infrastructure can always produce the authoritative record, regardless of third-party service availability. The discipline complements broader [[topic-data-governance|data governance]] obligations and the [[about-continuous-disclosure|continuous-disclosure regime]] applicable to the issuer.
