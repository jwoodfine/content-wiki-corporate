...
Professional Centres Mexico FIBRA aún no es un fideicomiso constituido. Todavía no se ha contratado a ningún Banco como fiduciario, no se ha designado a ningún miembro del Comité Técnico, y el fideicomiso no se ha presentado ante ningún regulador mexicano ni ha sido registrado por ninguno. Esta no es una oferta activa: no se ha emitido ningún CBFI, y ningún inversionista ha suscrito participaciones. El valor objetivo de financiamiento bruto de MN$5,000 millones referido en el [[four-jurisdiction-framework|Marco de Cuatro Jurisdicciones]] es una meta que el fideicomiso podría perseguir una vez constituido, no un compromiso, un monto ya recaudado ni una valuación vigente. Cada mecanismo que describe este artículo — el modelo de aislamiento por subsidiaria, el tratamiento de transparencia fiscal, el programa de deuda Cebures, el registro como FIBRA Privada — es un diseño planificado, aún no en operación.

## Véase también

- [[professional-centres-canada-lp-structure]] — el vehículo de Canadá ya constituido, estructurado como sociedad en comandita y no como fideicomiso
- [[four-jurisdiction-framework]] — el despliegue multijurisdiccional dentro del cual está previsto que opere este vehículo
- [[direct-hold-framework]] — la arquitectura general de aislamiento jurídico de Tenencia Directa que este fideicomiso planificado tiene previsto instanciar
- [[titleco-and-subsidiary-silo-model]] — la mecánica de Titleco a nivel de propiedad, bajo el modelo de Silo de Subsidiarias, compartida por los cuatro vehículos
- [[limited-partnership-structure]] — la forma de sociedad en comandita utilizada en Canadá y en el vehículo planificado de Estados Unidos, para contraste con esta forma fiduciaria
